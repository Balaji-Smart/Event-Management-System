    ...
    public partial class Loginpg : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            if (IsPostBack)
            {
                ...
                con.Open();
                string checkuser = "select count(*) from Register where UserName='" + TextBox2Password0.Text + "'";
                ...
                {
                    con.Open();
                    string checkPasswordQuery = "select Password from Register where UserName='" + TextBox2Password0.Text + "'";
